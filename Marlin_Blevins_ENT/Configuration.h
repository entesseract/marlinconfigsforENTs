...
// Ultimaker
    #define  DEFAULT_Kp 190.8
    #define  DEFAULT_Ki 23.86
    #define  DEFAULT_Kd 381.38
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100.5*.8,100.5*.8,400,842}  // default steps per unit for Ultimaker
